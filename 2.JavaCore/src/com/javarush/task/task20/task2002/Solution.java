...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File yourFile = new File("/home/sirojiddin/IdeaProjects/JavaRushTasks/2.JavaCore/src/com/javarush/task/task20/task2002/output");
