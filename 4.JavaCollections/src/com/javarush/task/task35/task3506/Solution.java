...
public class Solution {
    ...
    public static <T> void add(List<? super T> destinationList, List<? extends T> sourceList) {
        ListIterator<? super T> destListIterator = (ListIterator<? super T>) destinationList.listIterator();
        ListIterator<? extends T> srcListIterator = (ListIterator<? extends T>) sourceList.listIterator();
